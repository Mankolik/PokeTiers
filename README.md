...
- All 1,025 National Pokédex species, in Pokédex order
...
Open the local URL shown in the terminal. Production builds use `npm run build`.

Pokémon data and sprites are sourced from the open [PokéAPI](https://pokeapi.co/) project.
